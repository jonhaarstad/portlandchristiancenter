<?php /* Prayer Engine - RSS Feed of All Public Prayer Requests */
	...
	$getapprovedprayers = "SELECT * FROM prayers WHERE post_this = 1 AND (share_option = 'Share Online' OR share_option = 'Share Online Anonymously') ORDER BY date_received DESC";
