<?php /* Prayer Engine - Daily Report of All Public Prayer Requests */
	...
	$findprayers = "SELECT * FROM prayers WHERE post_this = 1 AND (share_option = 'Share Online' OR share_option = 'Share Online Anonymously') AND (DATE_SUB(CURDATE(),INTERVAL 1 DAY) <= date_received || date_received = CURDATE()) ORDER BY date_received DESC";	
...
<head>
	...
	<title>Prayer Engine - Requests Received in the Last Day</title>
	<link rel="stylesheet" href="../../stylesheets/prayerengine/pe_backend.css" type="text/css" />
</head>
<body id="report">

<h1>Prayer Requests From the Last Day</h1>
