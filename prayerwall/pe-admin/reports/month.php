<?php /* Prayer Engine - Monthly Report of All Public Prayer Requests */
	...
	$findprayers = "SELECT * FROM prayers WHERE post_this = 1 AND (share_option = 'Share Online' OR share_option = 'Share Online Anonymously') AND (DATE_SUB(CURDATE(),INTERVAL 30 DAY) <= date_received || date_received = CURDATE()) ORDER BY date_received DESC";	
...
<head>
	...
	<title>Prayer Engine - Prayer Requests From the Last Month</title>
